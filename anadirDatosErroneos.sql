USE [SerONoSer]
-- Borrar los datos anteriores para probar con estos
Delete RespNoValidas
Go
Delete Respuestas
Go
Delete Preguntas
...
-- Ahora genero una base de datos con errores:

-- No hay preguntas de nivel 2, siendo el nivel máximo el 4
-- Las preguntas 21 y 32 no tienen 8 respuestas válidas y 4 erróneas
--              (la 21 porque le faltan 2 respuestas y la 32 porque tiene 9 válidas y 3 erróneas)
...
GO
INSERT [dbo].[Preguntas] ([NumPregunta], [Enunciado], [Nivel]) VALUES (32, N'Lugares y Provincias a la que pertenecen', 3)
GO
INSERT [dbo].[Preguntas] ([NumPregunta], [Enunciado], [Nivel]) VALUES (43, N'Películas y países', 4)
GO
INSERT [dbo].[Preguntas] ([NumPregunta], [Enunciado], [Nivel]) VALUES (58, N'Locuciones y frases latinas', 3)
GO
...
GO
INSERT [dbo].[Preguntas] ([NumPregunta], [Enunciado], [Nivel]) VALUES (100, N'De la vida de Frida Kahlo', 3)
GO
...
GO
INSERT [dbo].[Respuestas] ([NumPregunta], [NumRespuesta], [PosibleRespuesta], [Valida]) VALUES (32, 4, N'Escalona: Cuenca', 1)
GO
